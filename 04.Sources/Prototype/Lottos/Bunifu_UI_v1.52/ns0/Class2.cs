...
namespace ns0
{
  internal class Class2
  {
    ...
    static Class2()
    {
      Class2.memoryStream_0 = new MemoryStream(0);
      Class2.memoryStream_1 = new MemoryStream(0);
    ...
    internal static byte[] smethod_2(Stream stream_0)
    {
      lock (Class2.object_0)
        return Class2.smethod_4(97L, stream_0);
    }
    ...
    internal static byte[] smethod_3(long long_0, Stream stream_0)
    {
      try
      {
        return Class2.smethod_2(stream_0);
      }
    ...
    internal static byte[] smethod_4(long long_0, Stream stream_0)
    {
      ...
      if (((int) num1 & 2) != 0)
      {
        ...
        if (flag)
          buffer2 = Class2.smethod_1(Assembly.GetExecutingAssembly());
        cryptoServiceProvider.Key = buffer2;
        if (Class2.memoryStream_0 == null)
          Class2.memoryStream_0.Capacity = Class2.int_0 != int.MaxValue ? Class2.int_0 : (int) stream_0.Length;
        ...
        while ((long) (position + inputBlockSize) < stream_0.Length)
        {
          ...
          Class2.memoryStream_0.Write(numArray1, 0, count);
        ...
        Class2.memoryStream_0.Write(buffer3, 0, buffer3.Length);
        stream = (Stream) Class2.memoryStream_0;
        stream.Position = 0L;
      ...
      if (((int) num1 & 8) != 0)
      {
        if (Class2.memoryStream_1 == null)
          Class2.memoryStream_1.Capacity = Class2.int_1 != int.MinValue ? Class2.int_1 : (int) stream.Length * 2;
...
label_21:
          continue;
label_22:
          Class2.memoryStream_1.Write(buffer, 0, count2);
          goto label_21;
        }
        while (count2 >= count1);
